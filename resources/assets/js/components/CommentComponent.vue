<template>
  <ul class="divide-y divide-gray-200 bg-">
    <li v-for="message in messages" :key="message.id" class="relative bg-white py-5 px-1 hover:bg-gray-50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
